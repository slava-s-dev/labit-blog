...
namespace {
    ...
    class Minify extends \Devfactory\Minify\Facades\MinifyFacade{
        ...
        public static function javascript($file, $attributes = array()){
            return \Devfactory\Minify\Minify::javascript($file, $attributes);
        }
        ...
        public static function stylesheet($file, $attributes = array()){
            return \Devfactory\Minify\Minify::stylesheet($file, $attributes);
        }
        ...
        public static function stylesheetDir($dir, $attributes = array()){
            return \Devfactory\Minify\Minify::stylesheetDir($dir, $attributes);
        }
        ...
        public static function javascriptDir($dir, $attributes = array()){
            return \Devfactory\Minify\Minify::javascriptDir($dir, $attributes);
        }
        ...
        public static function withFullUrl(){
            return \Devfactory\Minify\Minify::withFullUrl();
        }
        ...
        public static function onlyUrl(){
            return \Devfactory\Minify\Minify::onlyUrl();
        }
    ...
    class Jarboe extends \Vis\Builder\Facades\Jarboe{
        ...
        public static function table($options){
            return \Vis\Builder\Jarboe::table($options);
        }
         ...
         * @static 
         */
        public static function checkNavigationPermissions(){
            return \Vis\Builder\Jarboe::checkNavigationPermissions();
        }
        ...
        public static function urlify($string){
            return \Vis\Builder\Jarboe::urlify($string);
        }
         ...
         * @static 
         */
        public static function tree($model = 'Vis\Builder\Tree', $options = array(), $nameTree = 'tree'){
            return \Vis\Builder\Jarboe::tree($model, $options, $nameTree);
        }
